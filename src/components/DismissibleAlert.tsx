    ...
    <Alert className={cn(variantStyles[variant], className)}>
      ...
      <AlertTitle className="flex items-center justify-between">
        ...
        <button
          ...
          className="ml-2 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none"
